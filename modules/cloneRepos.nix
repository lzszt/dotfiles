      ...
      let
        ...
        cloneOrRecurse =
          ...
          if (builtins.hasAttr "url" value) then
            ...
            lib.concatLines (lib.mapAttrsToList (name: value: cloneOrRecurse path name value) value);

        gitCloneScript = lib.concatLines (
          lib.mapAttrsToList (name: value: cloneOrRecurse "" name value) cfg.git.repos
        );
